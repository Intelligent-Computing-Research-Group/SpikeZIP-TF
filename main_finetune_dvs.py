...
def main(args):
    ...
    if global_rank == 0 and args.log_dir is not None and not args.eval:
        ...
        args.log_dir = os.path.join(args.log_dir,
                                    "{}_{}_{}_{}_{}_{}".format(args.project_name, args.model, args.dataset,
                                                               args.act_layer, args.mode, args.level))
        os.makedirs(args.log_dir, exist_ok=True)
        log_writer = SummaryWriter(log_dir=args.log_dir)
        if args.wandb:
            wandb.init(config=args, project=args.project_name,
                       name="{}_{}_{}_{}_{}_{}".format(args.project_name, args.model, args.dataset, args.act_layer,
                                                       args.mode, args.level),
                       dir=args.output_dir)
    else:
        log_writer = None
